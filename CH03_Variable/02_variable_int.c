...
int main(){
    ...
    int in = 2147483647; // int의 최대값(-2147483647 ~ 2147483647)
    long ln = 2147483647; // long의 최대값(-2147483647 ~ 2147483647)
    long long lln = 1234567890123456789; // long long의 최대값(그냥 큰 값)
